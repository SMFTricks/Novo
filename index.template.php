...
<div id="wrapper" style="width: ' . $settings['forum_width'] . '">' : '', '
	...
	<div id="header">
		<h1 class="forumtitle">
			<a href="', $scripturl, '">', empty($context['header_logo_url_html_safe']) ? '<img onmouseover="$(this).fadeTo(\'slow\', 0.40);" onmouseout="$(this).fadeTo(\'slow\', 0.99);" src="' . $settings['images_url'] . '/theme/logo.png" alt="' . $context['forum_name'] . '" />' : '<img onmouseover="$(this).fadeTo(\'slow\', 0.40);" onmouseout="$(this).fadeTo(\'slow\', 0.99);" src="' . $context['header_logo_url_html_safe'] . '" alt="' . $context['forum_name'] . '" />', '</a>
		</h1>
	...
	if ($context['user']['is_logged'])
	{
		if (!empty($context['user']['avatar']))
			...
			echo '
				<img class="avatar" src="', $settings['images_url'], '/theme/noavatar.png" alt="', $txt['profile'], '" />';
...
function template_body_below()
{
	...
	<div id="footer_section">
		...
		<ul class="reset floatright" style="text-align: right;">
			<li class="copyright">', novo_copyright(), '</li>
...
function template_menu()
{
	...
	echo '
		<div class="menu_responsive">
			<span class="menu_t">', $txt['menu'], '</span>
			<a href="#" id="pull"></a>
			<ul class="menu">';
...
// Novo Copyright, DO NOT REMOVE THIS!!
function novo_copyright()
{
	$NOVO = 'Theme by <a href="https://smftricks.com">SMF Tricks</a>';
	return $NOVO;
}
